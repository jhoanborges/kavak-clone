    ...
    <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
      <div className="w-full max-w-sm flex flex-col gap-6">
        ...
        <div className="flex rounded-lg border border-border bg-white overflow-hidden shadow-sm focus-within:ring-2 focus-within:ring-primary/30 focus-within:border-primary transition-all">
          <button type="button" className="flex items-center gap-1.5 px-3 border-r border-border text-sm font-medium text-foreground shrink-0 cursor-pointer hover:bg-muted transition-colors">
        ...
        <button
          ...
          style={{ backgroundColor: phone.replace(/\D/g, "").length >= 10 ? "var(--color-brand-petrol)" : "var(--color-ink-500)" }}
        >
          Continuar
        </button>

        <button type="button" className="w-full h-12 flex items-center justify-center gap-2.5 border border-border rounded-lg bg-white text-sm font-medium text-foreground hover:bg-muted transition-colors cursor-pointer shadow-sm">
